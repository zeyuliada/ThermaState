...
static const std::string father_path = "../data/";
...
#define max_root_fan_out float(4096.0)
#define min_inner_fan_out float(1.0)
//#define max_inner_fan_out 333
#define max_inner_fan_out float(256.0)
...
#define VALUE_SIZE 1
#define MEMORY_WEIGHT 0.5
#define QUERY_WEIGHT 0.5
